...
(async function(){
  ...
  chartInstance.setOption({
    ...
    grid: { left: 110, right: 200, top: 36, bottom: 40 },
    xAxis: {
    ...
    yAxis: [
      ...
      { type: 'value', name: 'Fed 利率', position: 'left',
...
function renderClassicChart(d, container) {
  ...
  chartInstance.setOption({
    ...
    yAxis:[{type:'value',name:'BTC (USD)',position:'left',nameTextStyle:{color:'#f7931a',fontSize:11},axisLabel:{color:'#f7931a',fontSize:11,formatter:function(v){return v>=1000?(v/1000).toFixed(0)+'K':v;}},splitLine:{lineStyle:{color:'rgba(255,255,255,0.04)'}}},{type:'value',name:'Fed 利率',position:'left',nameTextStyle:{color:'#b388ff',fontSize:11},axisLabel:{color:'#b388ff',fontSize:11,formatter:function(v){return v.toFixed(1)+'%';}},splitLine:{show:false}},{type:'value',name:'DXY',position:'right',nameTextStyle:{color:'#00e5ff',fontSize:11},axisLabel:{color:'#00e5ff',fontSize:11},splitLine:{show:false}},{type:'value',name:'10Y %',position:'right',nameTextStyle:{color:'#00e676',fontSize:11},axisLabel:{color:'#00e676',fontSize:11,formatter:function(v){return v.toFixed(1)+'%';}},splitLine:{show:false}},{type:'value',name:'黄金 (USD/oz)',position:'right',nameTextStyle:{color:'#ffd700',fontSize:11},axisLabel:{color:'#ffd700',fontSize:10,formatter:function(v){return '$'+v.toFixed(0);}},splitLine:{show:false}},{type:'value',name:'原油 (USD/bbl)',position:'right',nameTextStyle:{color:'#ff5252',fontSize:11},axisLabel:{color:'#ff5252',fontSize:10,formatter:function(v){return '$'+v.toFixed(0);}},splitLine:{show:false}},{type:'value',name:'纳斯达克',position:'right',nameTextStyle:{color:'#4fc3f7',fontSize:11},axisLabel:{color:'#4fc3f7',fontSize:10,formatter:function(v){return v>=1000?(v/1000).toFixed(0)+'K':v;}},splitLine:{show:false}}],
